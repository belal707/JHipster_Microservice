...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "catalog@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "catalog API";

        private String description = "catalog API documentation";
